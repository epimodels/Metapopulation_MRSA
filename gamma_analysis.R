...
gammasweep <- glm(cases ~ gamma + I(gamma^2),family="poisson")
summary(gammasweep)
...
plot(gamma,cases,pch=21,col="grey90",bg="grey90",xlab=expression(gamma),ylab="MRSA Acquisitions",cex.lab=1.45)
rect(xleft=lcl,xright=ucl,ybottom=0,ytop=200,col="lightcoral",density=90)
lines(modeldata$gamma,modeldata$fit, type="l",lwd=5)
